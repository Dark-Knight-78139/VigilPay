...
class KafkaProducerClient:
    ...
    def start(self):
        conf = {
            ...
            'client.id': 'feature-engineering-producer',
...
class KafkaConsumerClient:
    ...
    async def consume_loop(self, message_handler: Callable):
        ...
        while self.running:
            # Poll is blocking, so run in executor to not block asyncio event loop
            ...
            try:
                ...
                # In production, send to DLQ. For now, just log and continue/retry.
